...
- all available data from their favorite artist, album or show;
- _the possibility to search for Spotify content (development is in progress)_;
- the ability to control and interact with the playback(play, resume, seek to a position, or retrieve the queue);
